...
class TimePumpActiveWidget extends StatefulWidget {
  final String title;
  final String id;
  final String unit;
  ...
  @override
  _TimePumpActiveWidgetState createState() => _TimePumpActiveWidgetState();
}

class _TimePumpActiveWidgetState extends State<TimePumpActiveWidget> {
  bool _isFirst = true;
  bool valNotify;
  String valueChoose;
